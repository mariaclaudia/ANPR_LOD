SELECT ANPR.`__data_aggiornamento` as ANPR_data_aggiornamento,
    ...
    lpad(ANPR.idprovincia, 3, "0") as ANPR_idprovincia_t,
    ...
    ISTAT.ripartizione_geografica AS ISTAT_RIPARTIZIONE_GEOGRAFICA,
...
FROM anpr_comuni_italiani_view AS ANPR 
    ...
    where ANPR.altradenominazione is NULL or length(ANPR.altradenominazione)=0